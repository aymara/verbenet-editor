...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'VerbNetFrameSet.has_removed_frames'
        db.add_column('syntacticframes_verbnetframeset', 'has_removed_frames',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'VerbNetFrameSet.has_removed_frames'
        db.delete_column('syntacticframes_verbnetframeset', 'has_removed_frames')
