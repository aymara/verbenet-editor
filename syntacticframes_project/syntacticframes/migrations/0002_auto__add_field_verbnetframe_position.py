...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'VerbNetFrame.position'
        db.add_column('syntacticframes_verbnetframe', 'position',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'VerbNetFrame.position'
        db.delete_column('syntacticframes_verbnetframe', 'position')
