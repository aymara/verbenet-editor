...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        for vn_class in orm.VerbNetClass.objects.all():
            ...
            parent_frameset.paragon = vn_class.paragon
            parent_frameset.comment = vn_class.comment
            parent_frameset.save()

    def backwards(self, orm):
        for vn_class in orm.VerbNetClass.objects.all():
            parent_frameset = orm.VerbNetFrameSet.objects.get(verbnet_class=vn_class, parent=None)
            vn_class.paragon = parent_frameset.paragon
            vn_class.comment = parent_frameset.comment
            vn_class.save()
