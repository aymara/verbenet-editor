...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'VerbNetFrameSet.paragon'
        db.add_column('syntacticframes_verbnetframeset', 'paragon',
                      self.gf('django.db.models.fields.CharField')(blank=True, max_length=100, default=''),
                      keep_default=False)

        # Adding field 'VerbNetFrameSet.comment'
        db.add_column('syntacticframes_verbnetframeset', 'comment',
                      self.gf('django.db.models.fields.CharField')(blank=True, max_length=1000, default=''),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'VerbNetFrameSet.paragon'
        db.delete_column('syntacticframes_verbnetframeset', 'paragon')

        # Deleting field 'VerbNetFrameSet.comment'
        db.delete_column('syntacticframes_verbnetframeset', 'comment')
