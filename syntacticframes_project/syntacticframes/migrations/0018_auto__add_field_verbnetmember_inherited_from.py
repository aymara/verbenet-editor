...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'VerbNetMember.inherited_from'
        db.add_column('syntacticframes_verbnetmember', 'inherited_from',
                      self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['syntacticframes.VerbNetFrameSet'], related_name='inheritedmember_set'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'VerbNetMember.inherited_from'
        db.delete_column('syntacticframes_verbnetmember', 'inherited_from_id')
