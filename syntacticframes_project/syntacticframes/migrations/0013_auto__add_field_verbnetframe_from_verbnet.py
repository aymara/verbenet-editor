...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'VerbNetFrame.from_verbnet'
        db.add_column('syntacticframes_verbnetframe', 'from_verbnet',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'VerbNetFrame.from_verbnet'
        db.delete_column('syntacticframes_verbnetframe', 'from_verbnet')
    ...
    models = {
        ...
        'syntacticframes.verbnetframeset': {
            ...
            'parent': ('mptt.fields.TreeForeignKey', [], {'blank': 'True', 'related_name': "'children'", 'to': "orm['syntacticframes.VerbNetFrameSet']", 'null': 'True'}),
            'removed': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
