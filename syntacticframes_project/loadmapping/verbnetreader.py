...
VERBNET_PATH = 'resources/verbnet-3.2'
...
class VerbnetReader:
    ...
    def __init__(self, path):
        ...
        for filename in os.listdir(path):
            ...
            root = ET.ElementTree(file=join(path, self.filename))
...
class VerbnetReaderTest(unittest.TestCase):
    ...
    def test_global(self):
        reader = VerbnetReader(VERBNET_PATH)
        ...
        reader.verbs = {}
        root = ET.ElementTree(file=join(VERBNET_PATH, "separate-23.1.xml"))
