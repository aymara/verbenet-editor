prep = {
    ...
    "loc": {
        ...
        "amongst", "around", "astride", "at", "athwart", "before", "behind",
        "below", "beneath", "beside", "between", "beyond", "by", "from", "in",
        "in_front_of", "inside", "near", "next_to", "off", "on", "opposite",
        "out_of", "outside", "over", "round", "throughout", "under",
...
other_preps = {
    "among", "respecting", "into", "as", "through", "at", "in", "before",
    "from", "for", "to", "concerning", "under", "until", "over", "towards",
    "out_of", "between", "upon", "regarding", "in_between", "with", "by",
    "after", "on", "about", "off", "of", "against", "onto"
}
